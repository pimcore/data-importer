 ...
 * @internal
 */
final readonly class ConnectionHydrator implements ConnectionHydratorInterface
{
    public function hydrateConnections(array $connections): ConnectionsResponse
    {
