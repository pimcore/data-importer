 ...
 * @internal
 */
final class NoChangePublishNewStrategy implements PublishStrategyInterface, SchemaAwareInterface
{
    ...
    {
        return 'Publishes newly created objects but does not change the publish state of existing ones';
    }
