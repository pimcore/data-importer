...
class PimcoreDataImporterBundle extends AbstractPimcoreBundle implements DependentBundleInterface, PimcoreBundleAdminClassicInterface
{
    ...
    public function getJsPaths(): array
    {
        return [
            ...
            '/bundles/pimcoredataimporter/js/pimcore/configuration/components/resolver/load/composedPath.js',
            '/bundles/pimcoredataimporter/js/pimcore/configuration/components/resolver/load/property.js',
            ...
            '/bundles/pimcoredataimporter/js/pimcore/configuration/components/resolver/location/composedParent.js',
            ...
            '/bundles/pimcoredataimporter/js/pimcore/configuration/components/mapping/datatarget/property.js',
