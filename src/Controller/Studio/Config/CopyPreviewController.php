 ...
 * @internal
 */
final class CopyPreviewController extends AbstractApiController
{
    private const string ROUTE = '/config/{name}/copy-preview';
    ...
    #[Post(
        ...
        description: 'bundle_data_importer_config_copy_preview_description',
        summary: 'bundle_data_importer_config_copy_preview_summary',
    ...
    #[ReferenceRequestBody(CopyPreviewParameters::class)]
    #[SuccessResponse(
        description: 'bundle_data_importer_config_copy_preview_success_response',
    )]
    ...
    public function copyPreviewData(
        string $name,
        #[MapRequestPayload] CopyPreviewParameters $parameters
    ): Response {
        $this->previewDataService->copyPreviewData($name, $parameters->getCurrentConfig(), $parameters->getPreviewScope());
