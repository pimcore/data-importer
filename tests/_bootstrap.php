...
if (file_exists(__DIR__ . '/../vendor/autoload.php')) {
    ...
    file_exists(getenv('PIMCORE_PROJECT_ROOT') . '/vendor/autoload.php')
) {
...
Autoloader::addNamespace('Pimcore\Bundle\DataImporterBundle\Tests', __DIR__);
Autoloader::addNamespace('Pimcore\Bundle\DataImporterBundle\Tests', __DIR__ . '/_support');
