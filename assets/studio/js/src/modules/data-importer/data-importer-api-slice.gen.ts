...
const injectedRtkApi = api
    ...
    .injectEndpoints({
        endpoints: (build) => ({
            ...
            bundleDataImporterConfigLoadColumnHeaders: build.mutation<
            ...
            bundleDataImporterConfigLoadPreview: build.mutation<
            ...
            bundleDataImporterConfigLoadTransformationResult: build.mutation<
...
export const {
    useBundleDataImporterConfigCalculateTransformationResultTypeMutation,
    ...
    useBundleDataImporterConfigLoadColumnHeadersMutation,
    useBundleDataImporterConfigLoadPreviewMutation,
    useBundleDataImporterConfigLoadTransformationResultMutation,
