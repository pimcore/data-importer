...
export function IdLoadingStrategyResolverSettings({ columnHeaderOptions }: DynamicTypeResolverRenderProps) {
    const { t } = useTranslation();

    return (
        <>
            <DataImporterPanel theme="fieldset" title={t('data-importer.resolver.loading-strategy.id')}>
                <Form.Item
