...
export interface CardNode {
  readonly key: string
  /** a section the editor is not currently showing; the pipeline's steps are never muted */
...
/**
 * The rail of a proposal, whichever kind it is: the configuration it is about, then a dotted
 * spine of everything worth saying about it. Nothing here decides anything — a proposal is
 * approved or rejected whole — so the only control is a section label, which opens it.
 */
